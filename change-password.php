                                ...
                                <form class="pt-3" id="login_form">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control form-control-lg border-left-0" id="" name="" placeholder="Old password">
                                        </div>
                                    </div>
									<div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control form-control-lg border-left-0" id="" name="" placeholder="New password">
                                        </div>
                                    </div>
									<div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control form-control-lg border-left-0" id="" name="" placeholder="Confirm new password">
                                        </div>
                                    </div>
                                    <div class="my-3">
                                        <button class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" id="">Change password</button>
                                    </div>
                                </form>
                            </div>
                        </div>

(function ($) {
    showSwal = function (type, title, message) {
        ...
        if (type === 'error') {
            ...
            swal({
                title: 'Are you sure you want to delete this customer with his bookings?',
                text: "You won't be able to revert this!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3f51b5',
                ...
                buttons: {
                    ...
                    confirm: {
                        ...
                        value: true,
                        visible: true,
                        className: "btn btn-primary delete_customer",
                        closeModal: false,
                    }
                }
            })
            ...
            swal({
                ...
                buttons: {
                    ...
                    confirm: {
                        ...
                        value: true,
                        visible: true,
                        className: "btn btn-primary delete_booking",
                        closeModal: false,
                    }
                }
            })

...
tpj(document).ready(function () {
    tpj("#burgernavbar").click(function () { //Sandeep burger clicked menu appeared
        ...
        tpj('#franchise').removeClass("animated fadeOutUp1").css("opacity", "0");
        ...
        setTimeout(function () {
            tpj('#home').addClass("animated fadeInDown1").css("opacity", "0");
        }, 100);//200
        setTimeout(function () {
            tpj('#about').addClass("animated fadeInDown1").css("opacity", "0");
        }, 200);//400
        setTimeout(function () {
            tpj('#legal').addClass("animated fadeInDown1").css("opacity", "0");
        }, 300);//600
        setTimeout(function () {
            tpj('#bankers').addClass("animated fadeInDown1").css("opacity", "0");
        }, 400);//800
        setTimeout(function () {
            tpj('#franchise').addClass("animated fadeInDown1").css("opacity", "0");
        }, 500);//800
        setTimeout(function () {
            tpj('#products').addClass("animated fadeInDown1").css("opacity", "0");
        }, 600);//1000
        setTimeout(function () {
            tpj('#realestate').addClass("animated fadeInDown1").css("opacity", "0");
        }, 700);//1200
        setTimeout(function () {
            tpj('#gallery').addClass("animated fadeInDown1").css("opacity", "0");
        }, 800);//300
        setTimeout(function () {
            tpj('#contact_us').addClass("animated fadeInDown1").css("opacity", "0");
        }, 900);//300
        setTimeout(function () {
            tpj('#login').addClass("animated fadeInDown1").css("opacity", "0");
        }, 1000);//300
    ...
    tpj(".iconCancel").click(function () {    //Sandeep when menu is closed using close button
        ...
        tpj('#franchise').removeClass("animated fadeInDown1").css("opacity", "1");
        ...
        setTimeout(function () {
            tpj('#home').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 1000);  //1400
        setTimeout(function () {
            tpj('#about').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 900);   //1200
        setTimeout(function () {
            tpj('#legal').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 800);   //1000
        setTimeout(function () {
            tpj('#bankers').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 700);    //800
        setTimeout(function () {
            tpj('#franchise').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 600);    //800
        setTimeout(function () {
            tpj('#products').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 500);    //600
        setTimeout(function () {
            tpj('#realestate').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 400);    //400
        setTimeout(function () {
            tpj('#gallery').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 300);    //200
        setTimeout(function () {
            tpj('#contact_us').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 200);    //200
        setTimeout(function () {
            tpj('#login').addClass("animated fadeOutUp1").css("opacity", "0");
        }, 100);    //200

        setTimeout(function () {
            tpj(".topBar").slideUp(400); //400

        ...
        <div class="shoppingCartContainer">
          ...
          <div class="js-cart-items">
            <div class="cartProductsContainer text-gray-dark cx-copy">
              ...
              <div class="scrollOverflow" id="items" style="display:none;">
            ...
            <div class="cart-footer">
              ...
              <div class="sales_notes mtNone">
                ...
                <form action="#" class="marginTop10">
                  <p>
                    <input type="radio" id="normal" name="dispatch_type" value="normal">
                    <label for="test2">Normal</label>
                  </p>
                  <p>
                    <input type="radio" id="return" name="dispatch_type" value="return">

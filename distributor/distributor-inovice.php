    ...
    <div class="global-viewport-container m-pikabu-container">
        <div id="mainContent" role="main" class="content" tabindex="-1">
            ...
            <div class="responsiveCenteredContent js-cart">
                ...
                <div class="backbtn_pos"><a class="btnBack" href="dashboard"><img src="<?php echo $home_url; ?>assets/javascript/distributor/images/backto.png" /> Back</a></div>
                            ...
                            <div class="cart-footer-main">
                                <div class="cart-footer-table totalsTbl">
                                    <div class="clearfix subTotal">
                                        <div class="js-cost cost text-gray-dark"><span id="orderSubTotal" role="alert" aria-live="assertive">TOTAL DUE: &#8377;<span id="totalPayment">0.00</span></span><span class="due_amount" style="display:none;">BALANCE DUE: &#8377;<span id="due_payment">0.00</span></span></div>

                                ...
                                <div>
                                    ...
                                    <section>
                                        <div class="terms_condition">
                                            Obedient Marketing Universal Private Limited, a company incorporated under the Companies Act, 1956 and having its Registered Office in Prayagraj, hereinafter referred to as "the Company or Obedient Group or we which ever is appropriate. The Company
                                            ...
                                            the Terms and Conditions mentioned. Obedient Group doesn't collect any Registration Charges and are absolutely FREE AND EASY to get enrolled as Customer/Registered Distributor.<br><br> Before filling the application
                                            ...
                                            website of the Company.<br> I. Website Means website of the Company https://myobedient.com/, https://myobedient.com/ or any official website (including through mode of mobile app) communicated through official
                                            communication channels of the company. Obedient Group has developed business brands within itself, each of which is a separate business identity in itself - Obedient Group Direct Selling Business Opportunity (https://myobedient.com/)
                                            INDIA SHOPPE Product Development, Retailing and Distribution (https://myobedient.com/) II. THE APPOINTMENT AND UNDERSTANDING a. The Company upon scrutiny and verification of the Application may consider the Applicant
                                            ...
                                            draft favouring "Obedient Marketing Universal Private Limited", Payable at Prayagraj, has to be sent / submitted at our authorized outlets, against which the product/s ordered will be delivered to the purchaser/authorized
                                            ...
                                            nor mandatory to participate in the business plan of Obedient Group and Purchasers who wish not to join the business can opt to do so by checking the "Free & Optional Business option' box during registration process.
                                            ...
                                            policies, etc., and also to make ensure that the purchaser is properly guided to buy Obedient Group products or before entering in to Obedient Group Business Opportunity) and such purchaser will be termed as "Consumer".
                                            vi. Independent distributors may refer new customers through â€˜Customer Registration Process'. However, these customers will not exist in the Business Opportunity system (genealogy/distributor) network. The customers
                                            ...
                                            from the company, but they will have all rights as a consumer and privileges being a registered consumer. vii. A consumer who has purchased the products from Obedient Group, can choose to join the business opportunity
                                            ...
                                            "Obedient Marketing Universal Private Limited payable at Prayagraj or through online payment gateway or swiping machine option or E-Wallet while placing the order. b. It is mutually agreed between the parties
                                            ...
                                            with the laws in force in India. Disputes, if any, shall be subject to the exclusive jurisdiction of the courts in Prayagraj. ii. If any dispute or difference arising out of or in relation to these presents, the same
                                            ...
                                            shall be Prayagraj_and Language shall be English. Declaration/Affirmation Solemnly affirm and declare as follows: 1. That I have read and understood the terms and conditions for â€˜Independent Distributorship " of the
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (response) {
                                                                ...
                                                                if (response.status == "success") {
                                                                    ...
                                                                    window.location.href = front_url + 'thank-you.php?name=' + name + '&username=' + username + '&password=' + password;

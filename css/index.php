...
<!--<a href="index.php" class="logoHeaderMain"><img style="height:120px;" src="images/obedient-logo.png" alt="" /></a>-->
    ...
    <section id="home" class="t-center white fullwidth">
        <!-- Hero Slider -->
        <div class="hero-slider height-760 custom-slider qdr-controls" data-slick='{"dots": true, "arrows": true, "autoplay": true, "autoplaySpeed": 4000, "speed": 700, "slidesToShow": 1, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 1}}]}'>
            <!-- Slide -->
            <div class="slide moving-container">
                <!-- Your Image -->
                <div class="slide-img bg-soft bg-soft-dark2" data-background="images/backgrounds/background_21.jpg"></div>
                <!-- Details -->
                <div class="details">
                    <!-- Centered Container -->
                    <div class="container v-center">
                        <div class="skrollr moving" data-0="opacity:1;" data-200="opacity:0;">
                            <div class="translatez-sm">
                                <h4 class="playfair italic animated font-16-mobile" data-animation="fadeInUp" data-animation-delay="600">
                                    We dreaming of the future. Join us!
                                </h4>
                            </div>
                            <div class="translatez-xs">
                                <h1 class="bold-title mini-mt animated font-16-mobile" data-animation="fadeInUp" data-animation-delay="800">
                                    Create your story with the Quadra Responsive theme.
                                </h1>
                            </div>
                            <div class="translatez-md">
                                <a href="products/" class="hero-slider-next lg-btn xxs-mt inline-block border-btn border-dashed border-gray3 radius-lg bold-subtitle font-12 white animated bg-colored1-hover border-colored1-hover slow" data-animation="fadeInUp" data-animation-delay="1000">
                                    OUR PRODUCTS
                                </a>&nbsp;
								<a href="login/" class="hero-slider-next lg-btn xxs-mt inline-block border-btn border-dashed border-gray3 radius-lg bold-subtitle font-12 white animated bg-colored1-hover border-colored1-hover slow" data-animation="fadeInUp" data-animation-delay="1000">
                                    LOGIN
                                </a>
                            </div>
                        </div>
            ...
            <div class="slide moving-container">
                <!-- Your Image -->
                <div class="slide-img bg-soft bg-soft-dark2" data-background="images/backgrounds/background_19.jpg"></div>
                <!-- Details -->
                <div class="details">
                    <!-- Centered Container -->
                    <div class="container v-center">
                        <div class="skrollr moving" data-0="opacity:1;" data-200="opacity:0;">
                            ...
                            <div class="translatez-xs">
                                <h1 class="bold-title mini-mt animated font-16-mobile" data-animation="fadeInUp" data-animation-delay="800">
                                    Create your story with the Quadra <span class="playfair italic">Responsive theme.</span> 
                                </h1>
                            </div>
                            <div class="translatez-md">
                                <a href="products" class="hero-slider-next lg-btn xxs-mt inline-block border-btn border-dashed border-gray3 radius-lg bold-subtitle font-12 white animated bg-colored1-hover border-colored1-hover slow" data-animation="fadeInUp" data-animation-delay="1000">

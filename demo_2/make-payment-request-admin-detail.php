											...
											<div class="form-group row mb-0">
												...
												<div class="col-sm-8">
													<label class="col-form-label card-description mb-0">
														<a href="http://design.sappleserve.com/Obedient-Infra/assets/images/product_images_2/thumb_image1.jpg" target="_blank"><img src="../assets/images/product_images_2/thumb_image1.jpg" class="upload_img" id="photo" /></a>
													</label>
												</div>
											</div>
										</div>

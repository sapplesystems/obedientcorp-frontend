...
<div class="main-panel ">
    <div class="content-wrapper ">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="card-title mb-4">Offer Request List</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 customTabs">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="float-left col-md-3">
                                        <select class="form-control" id="agent-list" onchange="getOfferRequestList(this.value);"></select>
                                    </div>
                                </div>
        ...
        <script src="assets/javascript/offer_request.js"></script>
...
function removeButton(i) {
    document.getElementById('divCode_' + i).remove();
    x--;
...
function SubTotal() {
    ...
    $('.items').each(function () {
        var id = $(this).val();
        var bv_type = document.getElementById('product_coupon_type_' + id).value;
        ...
        ProductCouponType.push({'bv_type': bv_type, 'amount': Number(document.getElementById('tot_' + id).innerHTML)});
    });
...
function totalAppliedCoupon() {
    ...
    $('.bvcc').each(function () {
        ...
        var ccode = document.getElementById('ccode_' + id).value;
        var camnt = document.getElementById('camnt_' + id).value;
...
function removeCoupon(id) {
    ...
    var coupon_amt = document.getElementById('coupon_' + id).innerHTML;
    document.getElementById('coupon_tr_' + id).remove();
...
function removeCashTr(e, t, amnt) {
    e.preventDefault();
    document.getElementById('cash_tr_' + t).remove();

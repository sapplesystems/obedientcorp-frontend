...
<section id="home" class="xl-py t-center white fullwidth">
    ...
    <div class="bg-parallax skrollr" data-anchor-target="#home" data-0="transform:translate3d(0, 0px, 0px);" data-900="transform:translate3d(0px, 200px, 0px);" data-background="images/all-sites.jpg" style="background-position: center center;background-size: 100% 160%;"></div>
</section>
<!-- End Page Title -->
<!-- GALLERY -->
<section id="shop" class="sm-pt container t-left shop shop-styled minHeight200 py">
    ...
    <div class="t-center">
        <h1 class="extrabold-title">Our Projects</h1>
            ...
            success: function (response) {
                ...
                if (response.status == "success") {
                    ...
                    $.each(response.data, function (key, value) {
                        ...
                        if (value.map != '') {
                            map = '<a target="_blank" href="'+media_url + 'project_photo/' + value.map+'" class="btn btn-info btn-sm font-12 mt-2">Download Map</a>';
                        }

...
<section id="home" class="xl-py t-center fullwidth">
    ...
    <div class="bg-parallax skrollr" style="background-position: center 30%;" data-anchor-target="#home" data-0="transform:translate3d(0, 0px, 0px);" data-900="transform:translate3d(0px, 150px, 0px);" data-background="images/banking-banner.jpg"></div>

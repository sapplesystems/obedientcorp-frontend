...
<section id="home" class="xl-py t-center fullwidth">
    ...
    <div style="background-position:center 100%; background-size: 100% 170%;" class="bg-parallax skrollr custom_banner_pos_contact" data-anchor-target="#home" data-0="transform:translate3d(0, 0px, 0px);" data-900="transform:translate3d(0px, 150px, 0px);" data-background="images/contact-us.jpg"></div>
